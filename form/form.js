$(function() {
    ...
    $('#contactform').on('submit', function(e) {
        ...
        $.post($form.attr('action'), $form.serialize(), function(data) {
            ...
            $form.append('<div class="form-error">Wystąpił błąd podczas wysyłania formularza. Upewnij się, że wypełniłeś wszystkie pola i poprawnie rozwiązałeś działanie.</div>');
